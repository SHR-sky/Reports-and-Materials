...
int aixin[] = {2070,2190,1949,2307,1828,2419,1708,2524,1591,2619,1476,2703,1364,2774,1256,2829,1150,2867,1047,2888,946,2891,2878,751,2848,657,2803,566,2746,478,2680,394,2607,316,2532,243,2457,178,2387,121,2324,75,2272,39,2233,14,2208,2,2200,2200,2,220814,2233,39,2272,75,2324,121,2387,178,2457,243,2532,316,2607,394,2680,478,2746,566,2803,657,2848,751,2878,848,2891,946,2888,1047,2867,1150,2829,1256,2774,1364,2703,1476,2619,1591,2524,1708,2419,1828,2307,1949,2190,2070};
// 设定中断服务程序
...
void timerHandler()
{
    ...
    case 0x10:
    {
    	Xil_Out16(XPAR_AXI_QUAD_SPI_0_BASEADDR + XSP_DTR_OFFSET, aixin[ai]);
    	//for( j = 0;j <= 10000; j++ );
    	        break;
    }
    default:
...
{
    // 读取低 4 位开关，作为波形控制信号
    wave = Xil_In16(XPAR_AXI_GPIO_0_BASEADDR + XGPIO_DATA_OFFSET) & 0x1f;
    // 占空比 10%
