...
int main() {
	...
	Xil_Out32(XPAR_INTC_0_BASEADDR + XIN_IAR_OFFSET, XPAR_AXI_TIMER_0_INTERRUPT_MASK | XPAR_AXI_GPIO_0_IP2INTC_IRPT_MASK |
    ...
    Xil_Out32(XPAR_AXI_GPIO_2_BASEADDR + XGPIO_ISR_OFFSET, Xil_In32(XPAR_AXI_GPIO_0_BASEADDR + XGPIO_ISR_OFFSET));
    ...
    Xil_Out32(XPAR_INTC_0_BASEADDR+XIN_IMR_OFFSET,XPAR_AXI_TIMER_0_INTERRUPT_MASK | XPAR_AXI_GPIO_0_IP2INTC_IRPT_MASK |
    		XPAR_AXI_GPIO_2_IP2INTC_IRPT_MASK);

    Xil_Out32(XPAR_AXI_INTC_0_BASEADDR + XIN_IER_OFFSET, XPAR_AXI_GPIO_0_IP2INTC_IRPT_MASK);  // 开中断输出
